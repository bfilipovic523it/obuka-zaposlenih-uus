...
class UlogaController extends Controller
{
    ...
    public function store(UlogaStoreRequest $request): Response
    {
    ...
    public function show(Request $request, Uloga $uloga): Response
    {
    ...
    public function update(UlogaUpdateRequest $request, Uloga $uloga): Response
    {
    ...
    public function destroy(Request $request, Uloga $uloga): Response
    {
        $uloga->delete();
