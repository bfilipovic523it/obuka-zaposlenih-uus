...
<div class="layout">
    ...
    <aside class="sidebar">
        ...
        <nav class="sidebar-nav">
            <a href="{{ route('zaposleni.moje_obuke') }}"
                class="{{ request()->routeIs('zaposleni.moje_obuke') ? 'active' : '' }}">
                Moje obuke
            </a>
            <a href="{{ route('zaposleni.obuke.index') }}"
               class="{{ request()->routeIs('zaposleni.obuke.*') ? 'active' : '' }}">
               Dostupne obuke
            </a>
        </nav>
