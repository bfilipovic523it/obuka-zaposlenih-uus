...
@section('page-title', 'Kreiranje novog korisnika')
...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="training-card p-4">
            ...
            <h3 class="training-title mb-3 text-center">Kreirajte novog korisnika</h3>
            ...
            <form action="{{ route('users.store') }}" method="POST">
                ...
                <!-- Ime -->
                <div class="mb-3">
                    <label for="name" class="form-label"><strong>Ime i prezime:</strong></label>
                    <input
                        type="text"
                        name="name"
                        id="name"
                ...
                <!-- Lozinka -->
                <div class="mb-3">
                    <label for="password" class="form-label"><strong>Lozinka:</strong></label>
                    <input
                        type="password"
                        name="password"
                        id="password"
                ...
                <!-- Potvrda lozinke -->
                <div class="mb-3">
                    <label for="password_confirmation" class="form-label"><strong>Potvrda lozinke:</strong></label>
                    <input
                        type="password"
                ...
                <div class="mb-3">
                    ...
                    >
                        ...
                        @foreach($ulogas as $uloga)
                            <option value="{{ $uloga->id }}" {{ old('uloga_id') == $uloga->id ? 'selected' : '' }}>
                                {{ $uloga->naziv }}
                            </option>
                        @endforeach
                    </select>
