...
@section('title', 'Dodaj Obuku')
@section('page-title', 'Kreiranje nove obuke')
...
<div class="row justify-content-center">
    <div class="col-md-6">
        <div class="training-card p-4">
            ...
            <h3 class="training-title mb-3 text-center">Kreirajte novu obuku</h3>

            <form action="{{ route('obukas.store') }}" method="POST">
                @csrf
                ...
                <div class="mb-3">
                    ...
                    <textarea name="opis" id="opis" class="form-control @error('opis') is-invalid @enderror" rows="4">{{ old('opis') }}</textarea>
                    @error('opis')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <select name="sektor_id" id="sektor_id" class="form-select @error('sektor_id') is-invalid @enderror" required>
                ...
                <div class="mb-3">
                    ...
                    <select name="materijal_id" id="materijal_id" class="form-select @error('materijal_id') is-invalid @enderror" required>
                        <option value="">-- Izaberite materijal --</option>
                        @foreach($materijals as $materijal)
                            <option value="{{ $materijal->id }}" {{ old('materijal_id') == $materijal->id ? 'selected' : '' }}>
                                {{ $materijal->naziv }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="datum_pocetka" id="datum_pocetka" class="form-control @error('datum_pocetka') is-invalid @enderror" value="{{ old('datum_pocetka') }}" required>
                    @error('datum_pocetka')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" name="datum_zavrsetka" id="datum_zavrsetka" class="form-control @error('datum_zavrsetka') is-invalid @enderror" value="{{ old('datum_zavrsetka') }}" required>
                ...
                <div class="text-center">
                    <button type="submit" class="btn btn-primary">Sačuvaj Obuku</button>
                </div>
